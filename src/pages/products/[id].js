    ...
    <div>
      ...
      {/* <div className="flex flex-wrap justify-evenly m-4 p-4 border border-black rounded-lg shadow-xl">
        ...
        <div>
          ...
          <p className="text-center text-xl text-[#808080] mt-2">{product.description}</p>
      ...
      <section class="py-10 font-poppins border border-black m-4 rounded-lg">
        <div class="max-w-6xl px-4 mx-auto">
          <div class="flex flex-wrap mb-24 -mx-4">
            ...
            <div class="w-full px-4 md:w-1/2">
              <div class="lg:pl-20">
                <div class="mb-6 ">
                  <h2 class="max-w-xl mt-6 mb-6 text-xl font-semibold leading-loose tracking-wide text-black md:text-2xl">
                    {product.title}
                  </h2>
                  ...
                  <p class="inline-block text-2xl font-semibold text-black ">
